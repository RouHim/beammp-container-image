...
| TEMP_SETTINGS_FILE | The file name of a temporary ServerConfig that should replace the ServerConfig after server shutdown (e.g BeamJoy Map Switcher) | <empty>                      |
